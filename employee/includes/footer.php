    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <img src="img/logo_big_white.png" width="200" height="50" alt="">
                <p>A GLOBAL PARTNERSHIP FOR SUSTAINABLE AND RESILIENT LANDSCAPES
                </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a href="#">Progreen</a>, All Right Reserved.
                </div>
